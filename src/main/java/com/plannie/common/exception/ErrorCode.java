...
public enum ErrorCode {
    ...
    // StudySession
    STUDY_SESSION_NOT_FOUND(HttpStatus.NOT_FOUND, "SS001", "공부 세션을 찾을 수 없습니다."),
    STUDY_SESSION_ALREADY_ACTIVE(HttpStatus.CONFLICT, "SS002", "이미 진행 중인 세션이 있습니다."),
    STUDY_SESSION_NOT_ACTIVE(HttpStatus.BAD_REQUEST, "SS003", "진행 중인 세션이 아닙니다."),
